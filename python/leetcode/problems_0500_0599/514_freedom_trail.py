...
#     the center button to spell, which also counts as one step. After the pressing,
...
# Solution: https://youtu.be/NOgnlTXidSs
# Credit: Navdeep Singh founder of NeetCode
def find_rotate_steps_rec(ring, key):
    # Recursive solution
    cache = {}
...
def main():
    result = find_rotate_steps(ring = "godding", key = "gd")
    print(result) # 4

    result = find_rotate_steps(ring = "godding", key = "godding")
    print(result) # 13
