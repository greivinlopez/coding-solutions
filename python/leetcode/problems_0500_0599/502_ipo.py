...
# Solution: https://youtu.be/1IUzNJ6TPEM
...
def main():
    result = find_maximized_capital(k = 2, w = 0, profits = [1,2,3], capital = [0,1,1])
    print(result) # 4

    result = find_maximized_capital(k = 3, w = 0, profits = [1,2,3], capital = [0,1,2])
    print(result) # 6
