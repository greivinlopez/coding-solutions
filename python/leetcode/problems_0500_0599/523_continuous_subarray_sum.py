...
# Solution: https://youtu.be/OKcrLfR-8mE
...
def main():
    result = check_subarray_sum(nums = [23,2,4,6,7], k = 6)
    print(result) # True

    result = check_subarray_sum(nums = [23,2,6,4,7], k = 6)
    print(result) # True

    result = check_subarray_sum([23,2,6,4,7], k = 13)
    print(result) # False
