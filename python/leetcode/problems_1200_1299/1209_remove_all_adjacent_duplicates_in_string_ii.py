...
# Solution: https://youtu.be/w6LcypDgC4w
...
def main():
    result = remove_duplicates(s = "abcd", k = 2)
    print(result) # "abcd"

    result = remove_duplicates(s = "deeedbbcccbdaa", k = 3)
    print(result) # "aa"

    result = remove_duplicates(s = "pbbcggttciiippooaais", k = 2)
    print(result) # "ps"
