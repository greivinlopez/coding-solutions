...
# Solution: https://youtu.be/unIz8W9nuyk
...
def main():
    result = missing_rolls(rolls = [3,2,4,3], mean = 4, n = 2)
    print(result) # [6, 6]

    result = missing_rolls(rolls = [1,5,6], mean = 3, n = 4)
    print(result) # [2,3,2,2] -> this one differ from the actual result

    result = missing_rolls(rolls = [1,2,3,4], mean = 6, n = 4)
    print(result) # []
