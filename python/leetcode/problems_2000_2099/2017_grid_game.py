...
# Solution: https://youtu.be/B90kG-ZlptE
# Credit: Navdeep Singh founder of NeetCode
# This solution is actually better than the one in the video
def grid_game(grid):
    result = float("inf")
...
def main():
    result = grid_game([[2,5,4],[1,5,1]])
    print(result) # 4

    result = grid_game([[3,3,1],[8,5,2]])
    print(result) # 4

    result = grid_game([[1,3,1,15],[1,3,3,1]])
    print(result) # 7
