...
# [xi, yi, timei] indicates that person xi and person yi have a meeting at timei.
# A person may attend multiple meetings at the same time. Finally, you are given
...
# Solution: https://youtu.be/1XujGRSU1bQ
# Credit: Navdeep Singh founder of NeetCode
def find_all_people(n, meetings, firstPerson):
...
def main():
    result = find_all_people(n = 6, meetings = [[1,2,5],[2,3,8],[1,5,10]], firstPerson = 1)
    print(result) # [0,1,2,3,5]

    result = find_all_people(n = 4, meetings = [[3,1,3],[1,2,2],[0,3,3]], firstPerson = 3)
    print(result) # [0,1,3]

    result = find_all_people(n = 5, meetings = [[3,4,2],[1,2,1],[2,3,1]], firstPerson = 1)
