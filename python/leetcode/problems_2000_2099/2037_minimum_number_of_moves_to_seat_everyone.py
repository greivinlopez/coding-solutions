...
# also given the array students of length n, where students[j] is the position of
# the jth student.
# 
...
# Solution: https://youtu.be/wS7Ag33hf8E
...
def main():
    result = min_moves_to_seat(seats = [3,1,5], students = [2,7,4])
    print(result) # 4

    result = min_moves_to_seat(seats = [4,1,5,9], students = [1,3,2,6])
    print(result) # 7

    result = min_moves_to_seat(seats = [2,2,6,6], students = [1,3,2,6])
    print(result) # 4
