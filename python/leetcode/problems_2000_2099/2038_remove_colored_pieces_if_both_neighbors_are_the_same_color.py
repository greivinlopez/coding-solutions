...
#     neighbors are also colored 'A'. She is not allowed to remove pieces that are
#     colored 'B'.
#    
...
# There are only two 'A's and both are on the edge of the line, so she cannot move
# on her turn.
...
# Solution: https://youtu.be/T54GScWobZ4
...
def main():
    result = winner_of_game("AAABABB")
    print(result) # True

    result = winner_of_game("AA")
    print(result) # False

    result = winner_of_game("ABBBBBBBAAA")
    print(result) # False
