...
# Course 4 can be taken only after course 3 is completed, i.e., after 3 months. It
# is completed after 3 + 4 = 7 months.
...
# Solution: https://youtu.be/a_NlRPnqCrg
...
def minimum_time(n, relations, time):
    ...
    # Space: O(n + E) where E is the number of relations 


def main():
    result = minimum_time(n = 3, relations = [[1,3],[2,3]], time = [3,2,5])
    print(result) # 8

    result = minimum_time(n = 5, relations = [[1,5],[2,5],[3,5],[3,4],[4,5]], time = [1,2,3,4,5])
    print(result) # 12
