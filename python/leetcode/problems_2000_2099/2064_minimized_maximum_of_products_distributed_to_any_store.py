...
# are m product types of varying amounts, which are given as a 0-indexed integer
...
# Solution: https://youtu.be/GKSSr2xkR8A
...
def main():
    result = minimized_maximum(n = 6, quantities = [11,6])
    print(result) # 3

    result = minimized_maximum(n = 7, quantities = [15,10,10])
    print(result) # 5

    result = minimized_maximum(n = 1, quantities = [100000])
    print(result) # 100000
