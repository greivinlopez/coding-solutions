...
# Solution: https://youtu.be/jpKfrXetb9Q
...
def maximum_candies(candies, k):
    ...
    return res
    # Time: O(n * log(c)) where c is the total sum of candies
    # Credit: O(1)


def main():
    result = maximum_candies(candies = [5,8,6], k = 3)
    print(result) # 5

    result = maximum_candies(candies = [2,5], k = 11)
    print(result) # 0
