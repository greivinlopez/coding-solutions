...
# Solution: https://youtu.be/lPmkKnvNPrw
...
def main():
    result = find_min_arrow_shots([[10,16],[2,8],[1,6],[7,12]])
    print(result) # 2

    result = find_min_arrow_shots([[1,2],[3,4],[5,6],[7,8]])
    print(result) # 4

    result = find_min_arrow_shots([[1,2],[2,3],[3,4],[4,5]])
    print(result) # 2
