...
# so on, to produce a multilevel data structure as shown in the example below.
# 
...
# Solution: https://leetcode.com/problems/flatten-a-multilevel-doubly-linked-list/solutions/1947657/tc-o-n-sc-o-1-no-stack-no-recursion-simple-one-pass-python-solution
# Credit: Azaan Sherani -> https://leetcode.com/u/azaansherani/
def flatten(root):
    if root == None: return
    curr = root
    while curr:
