...
# string x, and invert(x) inverts all the bits in x (0 changes to 1 and 1 changes
# to 0).
# 
...
# Solution: https://youtu.be/h9DOEqeb_ZA
...
def main():
    result = find_kth_bit(n = 3, k = 1)
    print(result) # "0"

    result = find_kth_bit(n = 4, k = 11)
    print(result) # "1"
