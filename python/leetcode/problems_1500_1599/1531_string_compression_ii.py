...
# Solution: https://youtu.be/ISIG3o-Xofg
...
def main():
    result = get_length_of_optimal_compression(s = "aaabcccd", k = 2)
    print(result) # 4

    result = get_length_of_optimal_compression(s = "aabbaa", k = 2)
    print(result) # 2

    result = get_length_of_optimal_compression(s = "aaaaaaaaaaa", k = 0)
    print(result) # 3
