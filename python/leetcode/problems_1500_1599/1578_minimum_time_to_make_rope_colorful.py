...
# Solution: https://youtu.be/9_9jwd2DHMU
...
def main():
    result = min_cost(colors = "abaac", neededTime = [1,2,3,4,5])
    print(result) # 3

    result = min_cost(colors = "abc", neededTime = [1,2,3])
    print(result) # 0

    result = min_cost(colors = "aabaa", neededTime = [1,2,3,4,1])
    print(result) # 2
