...
# Solution: https://youtu.be/OKnm5oyAhWg
...
def main():
    result = successful_pairs(spells = [5,1,3], potions = [1,2,3,4,5], success = 7)
    print(result) # [4,0,3]

    result = successful_pairs(spells = [3,1,2], potions = [8,5,8], success = 16)
    print(result) # [2,0,2]
