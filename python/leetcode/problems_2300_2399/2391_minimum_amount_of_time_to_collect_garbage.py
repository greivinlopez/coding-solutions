# --------------------------------------------------
# 2391. Minimum Amount of Time to Collect Garbage 🗑️
# --------------------------------------------------
...
def garbage_collection(garbage, travel):
    ...
    # Time: O(n * m)
    # Space: O(1)
    # n = number of houses (length of garbage)
    # m = maximum length of any garbage string


def main():
    result = garbage_collection(garbage = ["G","P","GP","GG"], travel = [2,4,3])
    print(result) # 21

    result = garbage_collection(garbage = ["MMM","PGM","GP"], travel = [3,10])
    print(result) # 37
