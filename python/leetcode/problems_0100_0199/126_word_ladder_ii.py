...
# Solution: https://leetcode.com/problems/word-ladder-ii/solutions/2422401/46ms-python-97-faster-working-multiple-solutions-95-memory-efficient-solution
# Credit: Anuvab Chakraborty -> https://leetcode.com/u/anuvabtest/
def find_ladders(beginWord, endWord, wordList):
    ...
    # k = the total number of shortest paths


def main():
    result = find_ladders(beginWord = "hit", endWord = "cog", wordList = ["hot","dot","dog","lot","log","cog"])
    print(result) # [['hit', 'hot', 'dot', 'dog', 'cog'], ['hit', 'hot', 'lot', 'log', 'cog']]

    result = find_ladders(beginWord = "hit", endWord = "cog", wordList = ["hot","dot","dog","lot","log"])
    print(result) # []
