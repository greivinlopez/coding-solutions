...
def sort_by_bits(arr):
    ...
    return arr
    # Time: O(n * log(n)) 
    # Space: O(n)   = depending on the sort algorithm could be O(1)


def main():
    result = sort_by_bits([0,1,2,3,4,5,6,7,8])
    print(result) # [0, 1, 2, 4, 8, 3, 5, 6, 7]

    result = sort_by_bits([1024,512,256,128,64,32,16,8,4,2,1])
