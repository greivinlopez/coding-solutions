...
# Solution: https://algo.monster/liteproblems/1379
# Credit: AlgoMonster
def getTargetCopy(original, cloned, target):
    ...
    def dfs(original_node, cloned_node):
        ...
        # If current node in original tree is the target,
        # return the corresponding node in cloned tree
    ...
    # Start the DFS traversal from the roots of both trees
