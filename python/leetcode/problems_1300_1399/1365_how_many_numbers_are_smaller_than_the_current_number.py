...
# Solution: https://algo.monster/liteproblems/1365
# Credit: AlgoMonster
...
def main():
    result = smaller_numbers_than_current(nums = [8,1,2,2,3])
    print(result) # [4, 0, 1, 1, 3]

    result = smaller_numbers_than_current(nums = [6,5,4,8])
    print(result) # [2, 1, 0, 3]

    result = smaller_numbers_than_current(nums = [7,7,7,7])
