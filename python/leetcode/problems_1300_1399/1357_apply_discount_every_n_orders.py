...
# is calculated as the sum of each amount[j] * (price of the jth product).
# 
...
# the object with n, the discount, and the products and their prices.
#         double getBill(int[] product, int[] amount) Returns the final total of
# the bill with the discount applied (if any). Answers within 10-5 of the actual
...
# [[3,50,[1,2,3,4,5,6,7],[100,200,300,400,300,200,100]],[[1,2],[1,2]],[[3,7],[10,1
# 0]],[[1,2,3,4,5,6,7],[1,1,1,1,1,1,1]],[[4],[10]],[[7,3],[10,10]],[[7,5,3,1,6,4,2
...
# cashier.getBill([1,2],[1,2]);                     // return 500.0. 1stncustomer, no discount.
...
# Solution: https://algo.monster/liteproblems/1357
# Credit: AlgoMonster
...
class Cashier:
    def __init__(self, n: int, discount: int, products: List[int], prices: List[int]):
        ...
        Args:
            n: Every nth customer will receive the discount
            discount: Discount percentage to apply
            products: List of product IDs
            prices: List of corresponding product prices
        """
        # Counter to track the number of customers
        self.customer_count = 0
        # Every nth customer gets a discount
        self.n = n
        # Discount percentage
        self.discount = discount
        # Dictionary mapping product ID to its price
    ...
    def getBill(self, product: List[int], amount: List[int]) -> float:
        ...
        Args:
            product: List of product IDs being purchased
            amount: List of quantities for each product
        ...
        # Check if current customer is eligible for discount (every nth customer)
        ...
        for product_id, quantity in zip(product, amount):
            ...
            # Apply discount if eligible and add to total
