...
# is a path that starts from the upper left cell (0, 0) and ends at the bottom-
...
# 3) change the arrow to down with cost = 1 --> (3, 3)
# The total cost = 3.
# 
# Example 2:
# 
...
# Solution: https://youtu.be/3DwA6AsQvDI
...
def main():
    result = min_cost([[1,1,1,1],[2,2,2,2],[1,1,1,1],[2,2,2,2]])
    print(result) # 3

    result = min_cost([[1,1,3],[3,2,2],[1,1,4]])
    print(result) # 0

    result = min_cost([[1,2],[4,3]])
    print(result) # 1
