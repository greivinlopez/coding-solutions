...
# 
# A good line is a line of three or more cells (including the endpoints) where the
# endpoints of the line are one color, and the remaining cells in the middle are
# the opposite color (no cells in the line are free). You can find examples for
# good lines in the figure below:
#  
...
# The two good lines with the chosen cell as an endpoint are annotated above with
# the red rectangles.
# 
# Example 2:
# 
...
# Solution: https://youtu.be/KxK33AcQZpQ
...
def main():
    board = [[".",".",".","B",".",".",".","."],
             ...
             [".",".",".","B",".",".",".","."],
             [".",".",".","W",".",".",".","."]]
    result = check_move(board, rMove = 4, cMove = 3, color = "B")
    print(result) # True
    ...
    board = [[".",".",".",".",".",".",".","."],
             ...
             [".",".",".",".",".",".","W","."],
             [".",".",".",".",".",".",".","B"]]
    result = check_move(board, rMove = 4, cMove = 4, color = "W")
    print(result) # False
