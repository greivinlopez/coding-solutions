...
# Solution: https://youtu.be/2JG5rLM3vz8
# Credit: Navdeep Singh founder of NeetCode
def count_palindromic_subsequence(s):
    # This code is different than the explanation from the video
    count = 0
    chars = set(s)
    for char in chars:
...
def main():
    ...
    result = count_palindromic_subsequence("adc")
    print(result) # 0

    result = count_palindromic_subsequence("bbcbaba")
    print(result) # 4
