...
# obstacles of length n, where obstacles[i] describes the height of the i^th
# obstacle.
# 
...
# Solution: https://youtu.be/Xq9VT7p0lic
# Credit: Navdeep Singh founder of NeetCode
def longest_obstacle_course_at_each_position(nums):
    res = []
    dp = [10**8] * (len(nums) + 1)
...
def main():
    result = longest_obstacle_course_at_each_position([1,2,3,2])
    print(result) # [1,2,3,3]

    result = longest_obstacle_course_at_each_position([2,2,1])
    print(result) # [1,2,1]

    result = longest_obstacle_course_at_each_position([3,1,5,6,4,2])
    print(result) # [1,1,2,3,2,2]
