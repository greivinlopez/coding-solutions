...
# integers. Let there be another array, nums3, which contains the bitwise XOR of
...
# Solution: https://youtu.be/H9zVwDf6Frk
...
def xor_all_nums_alt(nums1, nums2):
    res = 0
...
def main():
    result = xor_all_nums(nums1 = [2,1,3], nums2 = [10,2,5,0])
    print(result) # 13

    result = xor_all_nums(nums1 = [1,2], nums2 = [3,4])
    print(result) # 0
