...
# Solution: https://youtu.be/9Ty_eRjoDNM
...
def main():
    result = is_circular_sentence("leetcode exercises sound delightful")
    print(result) # True

    result = is_circular_sentence("eetcode")
    print(result) # True

    result = is_circular_sentence("Leetcode is cool")
    print(result) # False
