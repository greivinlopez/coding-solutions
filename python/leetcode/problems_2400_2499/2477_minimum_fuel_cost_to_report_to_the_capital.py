...
# fuel.
# - Representative2 and representative3 go together to the capital with 1 liter of
# fuel.
# - Representative1 goes directly to the capital with 1 liter of fuel.
# - Representative5 goes directly to the capital with 1 liter of fuel.
# - Representative6 goes directly to city 4 with 1 liter of fuel.
# - Representative4 and representative6 go together to the capital with 1 liter of
# fuel.
...
# Solution: https://youtu.be/I3lnDUIzIG4
...
def main():
    result = minimum_fuel_cost(roads = [[0,1],[0,2],[0,3]], seats = 5)
    print(result) # 3

    result = minimum_fuel_cost(roads = [[3,1],[3,2],[1,0],[0,4],[0,5],[4,6]], seats = 2)
    print(result) # 7

    result = minimum_fuel_cost(roads = [], seats = 1)
    print(result) # 0
