...
#   room becomes free. The delayed meeting should have the same duration as the
#   original meeting.
#   
...
# room 0.
# - At time 2, rooms 1 and 2 are not being used. The second meeting starts in room
# 1.
...
def main():
    result = most_booked(n = 2, meetings = [[0,10],[1,5],[2,7],[3,4]])
    print(result) # 0

    result = most_booked(n = 3, meetings = [[1,20],[2,10],[3,5],[4,9],[6,8]])
    print(result) # 1
