...
# structure to track the ranges represented as half-open intervals and query about
# them.
# 
...
#     partially overlaps with currently tracked numbers should add any numbers in the
#     interval [left, right) that are not already tracked.
#   * boolean queryRange(int left, int right) Returns true if every real
#     number in the interval [left, right) is currently being tracked, and false
#     otherwise.
