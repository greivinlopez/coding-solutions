# ---------------------------------------
# 787. Cheapest Flights Within K Stops ✈️
# ---------------------------------------
...
# Solution: https://youtu.be/5eIK3zUdYmE
...
def main():
    result = find_cheapest_price(4,[[0,1,100],[1,2,100],[2,0,100],[1,3,600],[2,3,200]],0,3,1)
    print(result) # 700

    result = find_cheapest_price(3,[[0,1,100],[1,2,100],[0,2,500]],0,2,1)
    print(result) # 200

    result = find_cheapest_price(3,[[0,1,100],[1,2,100],[0,2,500]],0,2,0)
    print(result) # 500
