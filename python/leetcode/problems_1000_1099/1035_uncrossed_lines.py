...
# Solution: https://youtu.be/mnJF4vJ7GyE
...
def main():
    result = max_uncrossed_lines(nums1 = [1,4,2], nums2 = [1,2,4])
    print(result) # 2

    result = max_uncrossed_lines(nums1 = [2,5,1,2,5], nums2 = [10,5,2,1,5,2])
    print(result) # 3

    result = max_uncrossed_lines(nums1 = [1,3,7,1,7,5], nums2 = [1,9,2,5,1])
    print(result) # 2
