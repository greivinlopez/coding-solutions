...
# 
# You must buy exactly two chocolates in such a way that you still have some non-
# negative leftover money. You would like to minimize the sum of the prices of the
# two chocolates you buy.
# 
...
# Solution: https://youtu.be/BTzNimiQdW4
...
def main():
    result = buy_choco(prices = [1,2,2], money = 3)
    print(result) # 0

    result = buy_choco(prices = [3,2,3], money = 3)
    print(result) # 3
