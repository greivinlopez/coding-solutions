...
# The maximum difference is max(|nums[1] - nums[4]|, |nums[2] - nums[5]|) = max(0,
# 1) = 1. Therefore, we return 1.
# 
# Example 2:
# 
...
# Solution: https://youtu.be/lf1Pxg7IrzQ
...
def main():
    result = minimize_max(nums = [10,1,2,7,1,3], p = 2)
    print(result) # 1

    result = minimize_max(nums = [4,2,1,2], p = 1)
    print(result) # 0
