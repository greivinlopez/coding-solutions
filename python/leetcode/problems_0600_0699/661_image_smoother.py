...
def main():
    result = image_smoother(img = [[1,1,1],[1,0,1],[1,1,1]])
    print(result) # [[0,0,0],[0,0,0],[0,0,0]]

    result = image_smoother(img = [[100,200,100],[200,50,200],[100,200,100]])
    print(result) # [[137,141,137],[141,138,141],[137,141,137]]
