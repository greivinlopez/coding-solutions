...
# Solution: https://leetcodethehardway.com/solutions/0600-0699/find-duplicate-file-in-system-medium
...
def find_duplicate(paths):
    ...
    # Time: O(L)
    # Space: O(L)
    # L = the total length of the input string data (sum of the lengths of all strings in paths).


def main():
    result = find_duplicate(paths = ["root/a 1.txt(abcd) 2.txt(efgh)","root/c 3.txt(abcd)","root/c/d 4.txt(efgh)","root 4.txt(efgh)"])
    print(result) # [['root/a/1.txt', 'root/c/3.txt'], ['root/a/2.txt', 'root/c/d/4.txt', 'root/4.txt']]

    result = find_duplicate(paths = ["root/a 1.txt(abcd) 2.txt(efgh)","root/c 3.txt(abcd)","root/c/d 4.txt(efgh)"])
    print(result) # [['root/a/1.txt', 'root/c/3.txt'], ['root/a/2.txt', 'root/c/d/4.txt']]
