...
# Solution: https://youtu.be/69rcy6lb-HQ
...
def main():
    result = shortestAlternatingPaths(n = 3, redEdges = [[0,1],[1,2]], blueEdges = [])
    print(result) # [0, 1, -1]

    result = shortestAlternatingPaths(n = 3, redEdges = [[0,1]], blueEdges = [[2,1]])
    print(result) # [0, 1, -1]
