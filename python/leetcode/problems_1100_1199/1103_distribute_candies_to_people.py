...
# Solution: https://algo.monster/liteproblems/1103
# Credit: AlgoMonster
def distribute_candies(candies, num_people):
    ...
    return result
    # Time: O(max(sqrt(candies), num_people))
    # Space: O(num_people)


def main():
    result = distribute_candies(candies = 7, num_people = 4)
    print(result) # [1, 2, 3, 1]

    result = distribute_candies(candies = 10, num_people = 3)
    print(result) # [5, 2, 3]
