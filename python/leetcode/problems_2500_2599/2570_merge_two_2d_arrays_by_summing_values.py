...
#     the values of this id in the two arrays. If the id does not exist in one of the
...
# Solution: https://youtu.be/5MT4KsvOXYs
...
def main():
    result = merge_arrays(nums1 = [[1,2],[2,3],[4,5]], nums2 = [[1,4],[3,2],[4,1]])
    print(result) # [[1,6],[2,3],[3,2],[4,6]]

    result = merge_arrays(nums1 = [[2,4],[3,6],[5,5]], nums2 = [[1,3],[4,3]])
    print(result) # [[1,3],[2,4],[3,6],[4,3],[5,5]]
