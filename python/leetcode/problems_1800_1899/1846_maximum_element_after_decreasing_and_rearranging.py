...
#     than or equal to 1. In other words, abs(arr[i] - arr[i - 1]) <= 1 for each i
...
# Solution: https://youtu.be/o_hVl8IXuIE 
...
def main():
    result = maximum_element_after_decrementing_and_rearranging([2,2,1,2,1])
    print(result) # 2

    result = maximum_element_after_decrementing_and_rearranging([100,1,1000])
    print(result) # 3

    result = maximum_element_after_decrementing_and_rearranging([1,2,3,4,5])
    print(result) # 5
