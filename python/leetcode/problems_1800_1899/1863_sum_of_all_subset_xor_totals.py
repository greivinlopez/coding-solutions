...
# Solution: https://youtu.be/HToBFhTa1uQ
...
def main():
    result = subset_xor_sum(nums = [1,3])
    print(result) # 6

    result = subset_xor_sum(nums = [5,1,6])
    print(result) # 28

    result = subset_xor_sum(nums = [3,4,5,6,7,8])
    print(result) # 480
