# ------------------------------------
# 1882. Process Tasks Using Servers ⚙️
# ------------------------------------
...
# - At second 1, server 2 becomes free. Task 1 is added and processed using server
# 2 until second 3.
# - At second 2, task 2 is added and processed using server 0 until second 5.
# - At second 3, server 2 becomes free. Task 3 is added and processed using server
# 2 until second 5.
...
# - At second 4, server 1 becomes free. Task 4 is added and processed using server
# 1 until second 9.
...
# Solution: https://youtu.be/XKA22PecuMQ
...
def assign_tasks(servers, tasks):
    ...
    for i in range(len(tasks)):
        ...
        while unavail and t >= unavail[0][0]:
            time_free, weight, index = heapq.heappop(unavail)
...
def main():
    result = assign_tasks(servers = [3,3,2], tasks = [1,2,3,2,1,2])
    print(result) # [2,2,0,2,1,2]

    result = assign_tasks(servers = [5,1,4,3,2], tasks = [2,1,2,4,5,2,1])
    print(result) # [1,4,1,4,1,3,2]
