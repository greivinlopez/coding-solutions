...
#      value be largest. If there are multiple elements with the largest value, pick
#      the smallest i.
#   2. Find the next largest value in nums strictly smaller than largest. Let its value 
#      be nextLargest.
...
def main():
    result = reduction_operations([5,1,3])
    print(result) # 3

    result = reduction_operations([1,1,1])
    print(result) # 0

    result = reduction_operations([1,1,2,2,3])
    print(result) # 4
