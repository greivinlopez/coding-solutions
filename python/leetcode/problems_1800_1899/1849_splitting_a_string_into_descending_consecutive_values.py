...
#     with numerical values [90,89]. The values are in descending order and adjacent
#     values differ by 1, so this way is valid.
# 
#   * Another example, the string s = "001" can be split into ["0", "01"],
#     ["00", "1"], or ["0", "0", "1"]. However all the ways are invalid because they
#     have numerical values [0,1], [0,1], and [0,0,1] respectively, all of which are
...
# Solution: https://youtu.be/eDtMmysldaw
...
def main():
    result = split_string("1234")
    print(result) # False

    result = split_string("050043")
    print(result) # True

    result = split_string("9080701")
    print(result) # False
