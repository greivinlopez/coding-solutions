...
# Solution: https://youtu.be/5hQ5WWW5awQ
...
def main():
    result = min_interval(intervals = [[1,4],[2,4],[3,6],[4,4]], queries = [2,3,4,5])
    print(result) # [3,3,1,4]

    result = min_interval(intervals = [[2,3],[2,5],[1,8],[20,25]], queries = [2,19,5,22])
    print(result) # [2,-1,4,6]
