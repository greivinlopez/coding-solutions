...
# Solution: https://youtu.be/kShkQLQZ9K4
...
def main():
    result = merge_triplets(triplets = [[2,5,3],[1,8,4],[1,7,5]], target = [2,7,5])
    print(result) # True

    result = merge_triplets(triplets = [[3,4,5],[4,5,6]], target = [3,2,5])
    print(result) # False

    result = merge_triplets(triplets = [[2,5,3],[2,3,4],[1,2,5],[5,2,3]], target = [5,5,5])
    print(result) # True
