...
# Solution: https://leetcode.com/problems/patching-array/solutions/5319434/easy-to-understand-greedy-approach-detailed-explanation
...
def main():
    result = min_patches(nums = [1,3], n = 6)
    print(result) # 1

    result = min_patches(nums = [1,5,10], n = 20)
    print(result) # 2

    result = min_patches(nums = [1,2,2], n = 5)
    print(result) # 0
