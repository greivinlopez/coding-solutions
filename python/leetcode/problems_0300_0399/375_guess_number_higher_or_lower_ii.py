...
# Solution: https://leetcode.com/problems/guess-number-higher-or-lower-ii/solutions/1510747/python-dp-beat-97-52-in-time-99-in-memory-with-explanation
# Credit: https://leetcode.com/u/wingskh/
...
def main():
    result = get_money_amount(10)
    print(result) # 16

    result = get_money_amount(1)
    print(result) # 0

    result = get_money_amount(2)
    print(result) # 1
