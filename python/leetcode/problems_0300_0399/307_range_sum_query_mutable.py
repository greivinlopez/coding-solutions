...
#     nums between indices left and right inclusive (i.e. nums[left] + nums[left + 1]
#     + ... + nums[right]).
# 
# Example 1:
# 
...
# Solution: https://leetcode.com/problems/range-sum-query-mutable/solutions/2357596/using-segmented-tree-with-explanation-easy-to-understand
# Credit: Ankur Bhambri -> https://leetcode.com/u/ankurbhambri/
class Node(object):
    # Segment tree node
