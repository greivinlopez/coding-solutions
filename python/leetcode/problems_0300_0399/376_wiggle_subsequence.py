...
#     sequences. The first is not because its first two differences are positive, and
...
# Solution: https://leetcode.com/problems/wiggle-subsequence/solutions/1115202/python-js-java-go-c-o-n-dp-w-state-machine-diagram
...
def main():
    result = wiggle_max_length(nums = [1,7,4,9,2,5])
    print(result) # 6

    result = wiggle_max_length(nums = [1,17,5,10,13,15,10,5,16,8])
    print(result) # 7

    result = wiggle_max_length(nums = [1,2,3,4,5,6,7,8,9])
    print(result) # 2
