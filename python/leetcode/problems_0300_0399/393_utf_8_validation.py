...
# Solution: https://leetcode.com/problems/utf-8-validation/solutions/2577038/python3-10-lines-binary-pad-w-explanation-t-s-95-99
...
def main():
    result = valid_utf8(data = [197,130,1])
    print(result) # True

    result = valid_utf8(data = [235,140,4])
    print(result) # False
