...
#   * When the query matches a word up to capitalization, you should return
...
# Solution: https://algo.monster/liteproblems/966
# Credit: AlgoMonster
...
def main():
    ...
    result = spell_checker(wordlist, queries)
    print(result) # ["kite","KiTe","KiTe","Hare","hare","","","KiTe","","KiTe"]

    result = spell_checker(wordlist = ["yellow"], queries = ["YellOw"])
    print(result) # ["yellow"]
