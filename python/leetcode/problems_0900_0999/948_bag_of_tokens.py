...
#           tokeni_, losing tokens[i] power and gaining 1 score.
...
# down. You also cannot play it face-up since your power (50) is less than
# tokens[0] (100).
# 
# Example 2:
# 
...
# Solution: https://youtu.be/prI82maTivg
...
def main():
    result = bag_of_tokens_score(tokens = [100], power = 50)
    print(result) # 0

    result = bag_of_tokens_score(tokens = [200,100], power = 150)
    print(result) # 1

    result = bag_of_tokens_score(tokens = [100,200,300,400], power = 200)
    print(result) # 2
