...
# Solution: https://youtu.be/amnrMCVd2YI
...
def main():
    result = car_fleet(target = 12, position = [10,8,0,5,3], speed = [2,4,1,1,3])
    print(result) # 3

    result = car_fleet(target = 10, position = [3], speed = [3])
    print(result) # 1

    result = car_fleet(target = 100, position = [0,2,4], speed = [4,2,1])
    print(result) # 1
