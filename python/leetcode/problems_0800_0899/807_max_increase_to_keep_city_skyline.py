...
# Output: 0
# E
# xplanation: Increasing the height of any building will result in the skyline
# changing.
# 
# 
# Constraints:
...
# Solution: https://algo.monster/liteproblems/807
# Credit: AlgoMonster
...
def main():
    result = max_increase_keeping_skyline(grid = [[3,0,8,4],[2,4,5,7],[9,2,6,3],[0,3,1,0]])
    print(result) # 35

    result = max_increase_keeping_skyline(grid = [[0,0,0],[0,0,0],[0,0,0]])
    print(result) # 0
