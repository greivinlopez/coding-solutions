...
# 
# A directed edge from a to b in the graph means that team a is stronger than team
...
#     a directed edge from the node ai to node ai+1 for every i in the range [1, n].
...
# Output: 0
# 
# Explanation: Team 1 is weaker than team 0. Team 2 is weaker than team 1. So the
# champion is team 0.
# 
# Example 2:
# 
...
# Output: -1
# 
# Explanation: Team 2 is weaker than team 0 and team 1. Team 3 is weaker than team
# 1. But team 1 and team 0 are not weaker than any other teams. So the answer is
# -1.
# 
# 
# Constraints:
...
# Solution: https://youtu.be/HjSmSLPR7S4
...
def main():
    result = find_champion(n = 3, edges = [[0,1],[1,2]])
    print(result) # 0

    result = find_champion(n = 4, edges = [[0,2],[1,3],[1,2]])
    print(result) # -1
