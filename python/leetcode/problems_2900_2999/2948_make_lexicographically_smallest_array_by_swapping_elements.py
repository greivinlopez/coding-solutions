...
# Solution: https://youtu.be/-FGl6dzPexY
...
def main():
    result = lexicographically_smallest_array(nums = [1,5,3,9,8], limit = 2)
    print(result) # [1,3,5,8,9]

    result = lexicographically_smallest_array(nums = [1,7,6,18,2,1], limit = 3)
    print(result) # [1,6,7,18,1,2]

    result = lexicographically_smallest_array(nums = [1,7,28,19,10], limit = 3)
    print(result) # [1,7,28,19,10]
