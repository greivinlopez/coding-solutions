...
# Note that the company can also invite employees 1, 2, and 3, and give them their
# desired seats.
...
# The seating arrangement will be the same as that in the figure given in example
# 1:
...
# Solution: https://youtu.be/aPBELJa-LM8
...
def main():
    result = maximum_invitations([2,2,1,2])
    print(result) # True

    result = maximum_invitations([1,2,0])
    print(result) # True

    result = maximum_invitations([3,0,1,4,1])
    print(result) # False
