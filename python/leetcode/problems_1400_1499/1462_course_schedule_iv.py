...
# Solution: https://youtu.be/cEW05ofxhn0
...
def main():
    result = check_if_prerequisite(numCourses = 2, prerequisites = [[1,0]], queries = [[0,1],[1,0]])
    print(result) # [False, True]

    result = check_if_prerequisite(numCourses = 2, prerequisites = [], queries = [[1,0],[0,1]])
    print(result) # [False, False]

    result = check_if_prerequisite(numCourses = 3, prerequisites = [[1,2],[1,0],[2,0]], queries = [[1,0],[1,2]])
