...
# Solution: https://leetcode.com/problems/queries-on-a-permutation-with-key/solutions/575019/python-fenwick-tree-o-n-log-n/
# Credit: Alex Wice
class Fenwick:
    def __init__(self, n):
        sz = 1
...
def main():
    result = process_queries(queries = [3,1,2,1], m = 5)
    print(result) # [2,1,2,1]

    result = process_queries(queries = [4,1,2,2], m = 4)
    print(result) # [3,1,2,0]

    result = process_queries(queries = [7,5,5,8,3], m = 8)
    print(result) # [6,5,0,7,5]
