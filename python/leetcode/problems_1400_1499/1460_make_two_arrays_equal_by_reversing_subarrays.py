...
# Solution: https://youtu.be/XJkd8HKGcQw
...
def main():
    result = can_be_equal(target = [1,2,3,4], arr = [2,4,1,3])
    print(result) # True

    result = can_be_equal(target = [7], arr = [7])
    print(result) # True

    result = can_be_equal(target = [3,7,9], arr = [3,7,11])
    print(result) # False
