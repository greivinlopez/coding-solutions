...
# Solution: https://youtu.be/xCsIkPLS4Ls
...
def main():
    result = num_subseq(nums = [3,5,6,7], target = 9)
    print(result) # 4

    result = num_subseq(nums = [3,3,6,8], target = 10)
    print(result) # 6

    result = num_subseq(nums = [2,3,3,4,6,7], target = 12)
    print(result) # 61
