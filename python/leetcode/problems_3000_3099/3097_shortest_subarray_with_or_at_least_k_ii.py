...
# k.
# 
# Return the length of the shortest special non-empty subarray of nums, or return
...
# Solution: https://youtu.be/Bq_BEsgBQOs
...
def main():
    result = minimum_subarray_length([1,2,3], k = 2)
    print(result) # 1

    result = minimum_subarray_length([2,1,8], k = 10)
    print(result) # 3

    result = minimum_subarray_length([1,2], k = 0)
    print(result) # 1
