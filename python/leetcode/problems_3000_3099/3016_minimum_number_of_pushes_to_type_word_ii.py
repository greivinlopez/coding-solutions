# -------------------------------------------------
# 3016. Minimum Number of Pushes to Type Word II ☎️
# -------------------------------------------------
...
# "i" -> one push on key 9
# Total cost is 1 * 2 + 1 * 2 + 1 * 2 + 1 * 2 + 1 * 2 + 1 * 2 + 1 * 2 + 2 * 2 + 6
# * 1 = 24.
# It can be shown that no other mapping can provide a lower cost.
# 
# 
...
# Solution: https://youtu.be/gvaYi6X6SQw
...
def main():
    result = minimum_pushes(word = "abcde")
    print(result) # 5

    result = minimum_pushes(word = "xyzxyzxyzxyz")
    print(result) # 12

    result = minimum_pushes(word = "aabbccddeeffgghhiiiiii")
    print(result) # 24
