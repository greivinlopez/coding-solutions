...
# Solution: https://leetcode.com/problems/nim-game/solutions/3206199/determining-winning-strategy-in-nim-game-using-game-theory
# Credit: Mehmed Zawad -> https://leetcode.com/u/Rare_Zawad/
def can_win_nim(n):
    return n % 4 != 0
    # Time: O(1)
    # Space: O(1)
...
def main():
    result = can_win_nim(4)
    print(result) # False

    result = can_win_nim(1)
    print(result) # True

    result = can_win_nim(2)
    print(result) # True
