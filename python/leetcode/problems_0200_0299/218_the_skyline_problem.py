...
# buildings[i] = [leftᵢ, rightᵢ, heightᵢ]:
# 
...
# Solution: https://leetcode.com/problems/the-skyline-problem/solutions/2640697/python-easily-understood-faster-with-maximum-heap-explained
# Credit: Rajukommula -> https://leetcode.com/u/rajukommula/
...
def main():
    ...
    result = get_skyline([[0,2,3],[2,5,3]])
    print(result) # [[0,3],[5,0]]
