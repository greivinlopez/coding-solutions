...
# than the corresponding character in b. For example, "abcd" is lexicographically
...
def main():
    result = largest_merge(word1 = "cabaa", word2 = "bcaaa")
    print(result) # "cbcabaaaaa"

    result = largest_merge(word1 = "abcabc", word2 = "abdcaba")
    print(result) # "abdcabcabcaba"
