...
# Solution: https://youtu.be/d_cvtFwnOZg
...
def main():
    result = count_students(students = [1,1,0,0], sandwiches = [0,1,0,1])
    print(result) # 0

    result = count_students(students = [1,1,1,0,0,1], sandwiches = [1,0,0,0,1,1])
    print(result) # 3
