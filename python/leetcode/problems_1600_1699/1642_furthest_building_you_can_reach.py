...
# Solution: https://youtu.be/zyTeznvXCtg
...
def main():
    result = furthest_building(heights = [4,2,7,6,9,14,12], bricks = 5, ladders = 1)
    print(result) # 4

    result = furthest_building(heights = [4,12,2,7,3,18,20,3,19], bricks = 10, ladders = 2)
    print(result) # 7

    result = furthest_building(heights = [14,3,19,3], bricks = 17, ladders = 0)
    print(result) # 3
