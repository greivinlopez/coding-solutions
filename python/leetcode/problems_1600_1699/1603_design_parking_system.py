...
# respectively. A car can only park in a parking space of its carType. If there is
# no space available, return false, else park the car in that size space and
# return true.
# 
# Example 1:
# 
...
# Solution: https://youtu.be/d5zCHesOrSk
