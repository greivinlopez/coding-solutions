...
#     another team. A total of n / 2 matches are played, and n / 2 teams advance to
#     the next round.
...
# Solution: https://youtu.be/lslcc0tumpU
...
def main():
    result = number_of_matches(7)
    print(result) # 6

    result = number_of_matches(14)
    print(result) # 13
